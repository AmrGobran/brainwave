    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="mt-4 lg:ml-auto xl:w-152">
          <p className="body-2 mb-4 text-n-4 md:mb-12 lg:mb-24 lg:w-88 lg:mx-auto">
            {collabText}
          </p>

          <div className="relative left-1/2 flex w-88 aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100 md:mr-7">
